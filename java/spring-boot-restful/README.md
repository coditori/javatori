...
### Spring Rest of JAX-RS?
I prefer JAX-RS with an integration with spring-boot for more information see the [when to use column](https://github.com/massoudAfrashteh/code-examples)
